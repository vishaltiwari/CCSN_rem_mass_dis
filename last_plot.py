...
def main():
  ...
  for indx, m in enumerate(initial_mass_z1):
    if m in corrs_mass_z1:
      plt.scatter(m,fe_core_z1[indx],marker='^',color='blue',alpha=0.25)
      plt.scatter(m,si_core_z1[indx],marker='s',color='orange',alpha=0.25)
  for indx, m in enumerate(initial_mass_z2):
    if m in corrs_mass_z2:
      plt.scatter(m,fe_core_z2[indx],marker='^',color='blue',alpha=0.5)
      plt.scatter(m,si_core_z2[indx],marker='s',color='orange',alpha=0.5)
  
  for indx, m in enumerate(initial_mass_z3):
   if m in corrs_mass_z3:
     plt.scatter(m,fe_core_z3[indx],marker='^',color='blue',alpha=0.75)
     plt.scatter(m,si_core_z3[indx],marker='s',color='orange',alpha=0.75)
  for indx, m in enumerate(initial_mass_z4):
   if m in corrs_mass_z4:
     plt.scatter(m,fe_core_z4[indx],marker='^',color='blue',alpha=1.0)
     plt.scatter(m,si_core_z4[indx],marker='s',color='orange',alpha=1.0)
